        ...
        <div class="all">
            <div class="wrapper">
                ...
                <div class="form-wrapper">
                    <p class="pls">Please fill in your details so we can get you started. It takes less than 2 minutes</p>
                    <form action="{{route('farmer.store-reg')}}" method="post">
                        ...
                        <div class="accept">
                            ...
                            <p>
                                By checking this box, I agree to the the <button type="button" class="btn-link"  data-toggle="modal" data-target="#myModal"> terms and conditions </button> of
                                FarmCorps
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Our Terms and Conditions</h4>
                                </div>
                                <div class="modal-body">
                                    {{--<p>The identity and contact details of the organization, its representative, and its Data Protection Officer--}}
