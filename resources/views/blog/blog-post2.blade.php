...
<html lang="en">
	...
	<body>
		...
		<div class="hero-area section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/fh.png)"></div>
			<!-- /Backgound Image -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">HOW AFRICA CAN FEED THE WORLD BY 2050</h1>
						<ul class="blog-post-meta">
							<li class="blog-meta-author">By : <a href="#">Job Oyebisi</a></li>
							<li>25, March, 2019</li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="main" class="col-md-12">
						...
						<div class="blog-post">
							<div>
							<p>Agriculture is the go-to sector for most economies crosswise over Africa and the world.</p>
							<p>Food is the most imperative essential need of man. This is the reason the matter of growing them is a consistent one that won’t become dull at any point in the near future.</p>
							...
							<p>How is that so? Some would ask, giving that Agriculture has not yet taken centre stage like it should for such huge proposition.</p>
							<p>According to Microsoft,</p>
							<blockquote>
								<p>The key to making this lofty goal a reality? Better financing structures, easier access to markets, better education and more training – all underpinned by technology.</p>
								...
								<div class="col-md-6">
									...
									<img  style="width: 90%; height: 1%;" src="{{asset('blogasset/img/Freshmarte.png')}}" alt="">
								
							</div>
							<div class="blog-img col-md-6">
								
									<img  style="width: 90%; height: 1%;" src="{{asset('blogasset/img/lifer.png')}}" alt="">
							...
							<p>Most African farmers operate subsistence farming. There are few major scale farming businesses who attract investments.</p>
							<p>African governments can help by supporting and empowering these group of farmers.
							Adding to the funding hurdle, Microsoft reports the genius approach of Felix Musau, Kenyan small-scale farmer. The inventor designed an app that will showcase small scale farmers in need of a loan.</p>
							<p>The cloud-based App, AGIN which is supported by the Microsoft 4Afrika initiative and hosted on Microsoft Azure s used to collect and share information of these farmers with local banks. The advantage here is that it boosts the chances of potential yet unknown farmers in obtaining loans for their business.</p>

							<p><b>2. Recruiting More Young Farmers</b></p>
							<p>The present day African youth is the future of Africa. If the chunk of African farmers are the elderly, then the future of Agriculture in Africa is threatened.
							Some African countries have already started making plans to avoid this futuristic threat.</p>
							<p>Nigeria is considering the use of the annual NYSC scheme to improve the nation’s agricultural sector. Kenya is following suit.</p>

							<p><b>3. Technology</b></p>
							<p>Gradually the sensitization of going back to our fields has started manifesting in the business world. However before the agricultural revolution gets fully set into motion, Africa needs more farmers than it has now.</p>
							<blockquote>
								<p>By embracing technology, we can also entice more youth to pursue a career in agriculture. The average age of farmers in sub-Saharan Africa is 60 years old. With an aging population of farmers, it’s clear that agriculture has an image problem.</p>
							</blockquote>

							<p>Technology is being introduced in every facet of agriculture. From the funding and procurement, clearing of the land, planting, irrigation and harvesting, technology is re-branding the face of African agriculture.</p>
							...
							<p>Once the above mentioned factors are taken cognizance of, agriculture will be improved for the good of the continent and the world at large. </p>
