...
<html lang="en">
	...
	<body>
		...
		<div class="hero-area section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/1.png)"></div>
			<!-- /Backgound Image -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Returning Nigeria to the Golgen Age Of Agriculture</h1>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="main" class="col-md-12">
						...
						<div class="blog-post">
							<div>
							<p>Nigeria’s once thriving agricultural industry has now become a historical nostalgia. Prior to Nigeria’s discovery of oil in 1956 and the oil boom in the 1970s, the country was the world’s largest exporter of palm oil—well ahead of Malaysia and Indonesia. Ahead of the United States, Nigeria exported 47 per cent of the world’s groundnuts. As far as cocoa was concerned, in the 1960s Nigeria was the number two global producer and accounted for 18 per-cent of global cocoa production.</p>

							</div>
								<div class="blog-img ">
								<div class="col-md-6">
								<a href="">
									<img  style="width: 90%; height: 1%;" src="{{asset('blogasset/img/02%2020%2019.png')}}" alt="">
								</a>
							</div>
							<div class="blog-img col-md-6">
								<a href="">
									<img  style="width: 90%; height: 1%;" src="{{asset('blogasset/img/2.png')}}" alt="">
								</a>
								</div>
							</div>
							<br>
							<div>
							<p>Agriculture was not only more sustainable for the economy of the country, it was very inclusive as the revenue generated trickle down and permeated 70% of households in the country employed by the agricultural industry. It was the lust for the black gold and the mismanagement of the money that it returned that threw the country off the path of steady development and growth.</p>
								<p>To return back to the golden era of agriculture and its consequent sustainable development of our economy, we must;</p>


								<ol type="1">
								<li>improve smallholder farmers’ access to farm-inputs, markets and finances. Smallholders produce over 80% of our total national food, they are therefore key to the growth of our agricultural industry.</li>

								<li>improve agricultural research in seed breeding, crop protection extension and agricultural technology.</li>

								<li>rally public and private sector investments in agriculture to boost its growth and</li>

								<li>ease young people’s  participation in agribusiness to sustain its future.</li>
								</ol>
